...
@fig-bigon_collapse. The class of knots who have a presentation where bigons can
be collapsed to a single vertex with two self edges are called the **algebraic
knots**.
...
[@connollyClassificationTabulation2string2021], we call these singularly marked
polygonal graphs **constellations**. We call the tangle diagrams generated by
this approach the **polygonal diagrams**. If a tangle has no algebraic
representative we call it a **polygonal tangle**.
...
[^bigon]:
    ...
    eight sides or a trigon (triangle) has three.
