...
As we discussed in @sec-minimalization, that RLITT are often non-minimal
...
minimal. We saw in @sec-minimalization the ways canonization can increase
...
moves of the type similar to that seen in @fig-6starstar_nonminimal. The
...
(@fig-6starstar_nonminimal). We can see a second class in @fig-other_nonminimal.
