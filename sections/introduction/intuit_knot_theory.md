...
restrictions is the bread and butter of knot theory and the focus of the rest of
this thesis. Some great texts for continued reading on knot theory in order of
accessibility are: The Knot Book: An Elementary Introduction to the Mathematical
Theory of Knots by Adams @adamsKnotBookElementary2004 , LinKnot: Knot Theory by
Computer by Sazdanovic @jablanLinKnotKnotTheory2007 , Knots and Links by Rolfsen
@rolfsenKnotsLinks2003 , and An Introduction to Knot Theory by Lickorish
...
As we'll see in the following section mathematical knots and tangles have a
