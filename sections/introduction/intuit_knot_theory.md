...
in @fig-intro-everyday_knot_closed? When we try to wiggle the closed up string around, trying to
remove the knot, we stretch and pull on the string, but regardless of what we do, we end up with a
knot. Constructing a physical model of @fig-intro-everyday_knot_closed and playing with it should
...
the Mathematical Theory of Knots by Adams [@adamsKnotBookElementary2004], LinKnot: Knot Theory by
Computer by Jablan and Sazdanović [@jablanLinKnotKnotTheory2007], Knots and Links by Rolfsen
[@rolfsenKnotsLinks2003], and An Introduction to Knot Theory by Lickerish
[@lickorishIntroductionKnotTheory1997].
