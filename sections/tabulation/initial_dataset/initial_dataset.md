...
> rational tangles I make apart?", and "How do I generate new rational tangles?"
...
algebraic/arborescent case in @sec-arborescent. That approach takes the form of
the cadence:

1. Define the object.
2. Define equivalence for the object.
3. Identify a unique representation.
4. Generate those unique representitives[^rep].
...
[^rep]:
    Each tangle can be represented by an infinite number of diagrams. A unique
    representative in this context means a particular "flavor" of diagram that
