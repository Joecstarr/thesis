...
Let $\Gamma$ and $\Gamma^\prime$ be $\LP +\RP$-CWPTT (or  $\LP -\RP$-CWPTT) tangle trees with isomorphic
underlying abstract trees. Further, let $\varphi$ be a squence of moves of the
calculus of arboresent tangles. Assume that there is an $i > 1$ such that
...
1. either $\varphi$ reverses the cyclic order of bonds at $v_i$
2. or $\varphi$ does not respect the label in $V_4$ of some free bond of a
   vertex $v_j$ with $1 \leq j < i$.

Then $\varphi$ is not a squence of moves of the calculus of arboresent tangles
