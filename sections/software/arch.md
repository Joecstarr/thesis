...
projects or products. However, as we saw in our discussion of SnapPy (@sec-surveyoftools-snap), encapsulation
...
happen in the user interface layer, and then buffers with known sizes shall be passed to the functional components.
