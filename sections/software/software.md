...
engineering (@sec-product-vs-project). This includes the
development of model software engineering processes tailored for use in professional and
undergraduate mathematics research. Next, we use the engineering concepts of
@sec-product-vs-project to compare and contrast a
collection of tools currently
available for use in knot theory research
(@sec-surveyoftools). Using the
...
toolbox (@sec-archofktst). Finally, using this system
